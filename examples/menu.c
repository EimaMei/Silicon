...
bool windowShouldClose(id sender) {
	NSApplication_terminate(sender);
	return YES;
}
...
int main() {
	...
	NSApplication_setMainMenu(main_menu);
	...
	NSApplication_setServicesMenu(process_services); // Now 'Services' becomes a Services menu.
	...
	NSApplication_setWindowsMenu(windows_menu); // Set our menu into a Windows menu.

	// 'Help' menu
	NSMenu* help_menu = create_submenu(main_menu, "Help", nil, 0);
	NSApplication_setHelpMenu(help_menu); // Set our menu into a Help menu.
